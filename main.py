...
def draw_object_count(image_to_process, objects_count):
    ...
    font = cv2.FONT_HERSHEY_SIMPLEX
    width = 3
    text = "Object found: "+ str(objects_count)
...
def start_video_object_detection():
    while True:
        try:
            video_camera_capture = cv2.VideoCapture("http://81.130.138.82:82/mjpg/video.mjpg")
...
if __name__=='__main__':
    ...
    net = cv2.dnn.readNetFromDarknet("yolov4-tiny.cfg","yolov4-tiny_contrastive_last.weights")
